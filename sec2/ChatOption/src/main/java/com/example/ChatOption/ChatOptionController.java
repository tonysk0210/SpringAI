package com.example.ChatOption;

import com.example.ChatOption.advisors.TokenUsageAuditAdvisor;
...
public class ChatOptionController {
    ...
    public String promptStuffing(@RequestParam(value = "message") String message) {
        return chatClient.prompt()
                .options(new OpenAiChatOptions().builder().model(OpenAiApi.ChatModel.CHATGPT_4_O_LATEST).temperature(0.8).build()) //override default options, use CHATGPT_4_O_LATEST model with custom maxTokens and temperature
