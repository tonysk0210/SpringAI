package com.example.Advisor.chatClientConfig;
...
public class ChatClientConfig {
    ...
    public ChatClient chatClient(ChatClient.Builder chatClientBuilder) {
        ...
        return chatClientBuilder
                /**
                 這裡的 SimpleLoggerAdvisor 是 Spring AI 內建的一個 簡單日誌顧問 (Logging Advisor)，
                 它的功能是──在 每次 ChatClient 與模型互動時，記錄 prompt（提示）與 response（回覆）內容。
                 */
