...
public class ChatMemoryChatClientConfig {
     ...
     */
    @Bean
    RetrievalAugmentationAdvisor retrievalAugmentationAdvisor(VectorStore vectorStore) { //is a bean that QdrantVectorStore implements it based on the declaration of pom.xml
