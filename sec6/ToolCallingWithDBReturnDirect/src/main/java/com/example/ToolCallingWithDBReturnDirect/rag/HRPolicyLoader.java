package com.example.ToolCallingWithDBReturnDirect.rag;
...
public class HRPolicyLoader {
    ...
    public void LoadPDF() {
        ...
        TextSplitter tokenTextSplitter = TokenTextSplitter.builder().withChunkSize(200).withMaxNumChunks(400).build(); // 「每段 100 token、最多切 400 段」的 TokenTextSplitter，用來把長文字內容拆成多個較小的 Document，以便送入向量資料庫或 LLM 查詢
