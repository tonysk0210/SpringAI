package com.example.ToolCallingWithDBReturnDirect.tools;
...
import com.example.ToolCallingWithDBReturnDirect.service.HelpDeskTicketService;
...
public class HelpDeskTools {
    ...
    // returnDirect = true 表示直接回傳 String 給 LLM，而不是包在 ToolResponse 裡
